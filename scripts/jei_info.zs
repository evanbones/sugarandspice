...
s = "This wood spawns in Shadow Forests, in the Outer End.";
...
s = "Waxed crystal variants do not emit particles or grow, but share all other properties.";
...
// Neapolitan
s = "Spawns in tropical biomes and beaches. Can be farmed by planting Fronds on sand or gravel.";
...
i(<item:betterendforge:crystalite_chestplate>, s);
i(<item:betterendforge:crystalite_leggings>, s);
i(<item:betterendforge:crystalite_boots>, s);

s = "A common ore that spawns most frequently in the main end island.";
i(<item:betterendforge:ender_shard>, s);
i(<item:betterendforge:ender_ore>, s);

s = "Can display items. Also used for the process of Infusion.";
i(<item:betterendforge:quartz_pedestal>, s);
i(<item:betterendforge:purpur_pedestal>, s);
i(<item:betterendforge:andesite_pedestal>, s);
i(<item:betterendforge:diorite_pedestal>, s);
i(<item:betterendforge:granite_pedestal>, s);
